...
#         item3 = self.mu.seeding(3, True, False)
#         item4 = self.mu.seeding(4, True, False)
...
#     def test_edit(self):
#         item2 = self.mu.seeding(2, True, False)
#         # Update not exist
...
#         # Update success
#         vinmec_sites = self.vinmec_site_mu.seeding(3)
#         item2["vinmec_sites"] = [item.id for item in vinmec_sites]
#         resp = self.client.put(
...
#         staff = Staff.objects.get(pk=self.items[1].pk)
#         self.assertEqual(staff.vinmec_sites.count(), 3)
