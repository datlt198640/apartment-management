...
from ..helpers.model_utils import ClubInfoModelUtils

# Create your tests here.


class ClubInfoTestCase(TestCase):
    def setUp(self):
        self.base_url = "/api/v1/infomation/club/"
        self.base_url_params = "/api/v1/infomation/club/{}"
        self.model_utils = ClubInfoModelUtils()
    ...
    def test_create(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(ClubInfo.objects.count(), 4)
    ...
    def test_delete(self):
        ...
        self.assertEqual(response.status_code, 404)
        self.assertEqual(ClubInfo.objects.count(), 3)
        ...
        self.assertEqual(response.status_code, 204)
        self.assertEqual(ClubInfo.objects.count(), 0)
