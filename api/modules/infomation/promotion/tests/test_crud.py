...
from ..helpers.model_utils import PromotionModelUtils
...
class PromotionTestCase(TestCase):
    def setUp(self):
        self.base_url = "/api/v1/infomation/promotions/"
        self.base_url_params = "/api/v1/infomation/promotions/{}"
        self.model_utils = PromotionModelUtils()
